...
export default function VegetableCard(props) {
	...
	const level = function (difficulty) {
		let easy = (
			<img
				className="peppers"
				src={'../images/avatars/med-pepper.png'}
				alt={''}
			/>
		);
		let medium = (
			<img
				className="peppers"
				src={'../images/avatars/easy-pepper.png'}
				alt={''}
			/>
		);
		let hard = (
			<img
				className="peppers"
				src={'../images/avatars/hard-pepper.png'}
				alt={''}
			/>
		);
	...
	return (
		<div className="veg-card">
			<img className="media" src={props.image_url} alt="img" />
			<div className="veg-container">
				...
				<p>
					<ul className="body">
						...
						<li>
							Will be ready for harvest {props.harvest_date / 7} weeks after
							planting
						</li>
					</ul>
				</p>
